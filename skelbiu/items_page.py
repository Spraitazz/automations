...
class ItemsPage:
    ...
    #
    #
    # TODO: func naming convention unclear
    #
    def _renew_item(self) -> bool:
        """
    ...
    # TODO: func naming convention unclear
    #
    def _wait_renew_item_loaded(self) -> bool:
    ...
    def renew_item(self, item_id: str) -> bool:
        ...
        if clicked:
            click_delay()
            renew_page_loaded = self._wait_renew_item_loaded()
        ...
        self.logger.error(
            f"could not go to item (id = {item_id}) renew page by direct url, cannot renew"
        )
        return False
