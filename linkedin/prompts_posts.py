...
post2 = """Spent the weekend refactoring our event-driven data mesh architecture. Not because I had to — but because I wanted to.
...
post3 = """Building Diedai has taught me one thing: surround yourself with people who are smarter, kinder, and faster than you.
...
post4 = """What started as a sketch on a napkin is now a real product, real users, and real traction.
...
post5 = """Startup life isn’t always glamorous. Some weeks feel like everything’s on fire.
...
post6 = """We were excited to launch our new remote monitoring feature this week.
...
post7 = """We didn’t hit our launch target. We promised a feature that we couldn’t ship — yet.
...
post8 = """Quick update from the product side:
...
post9 = """We missed the launch window. But here’s the thing: the delay was earned.
...
ALL_POSTS = [post1, post2, post3, post4, post5, post6, post7, post8, post9]
